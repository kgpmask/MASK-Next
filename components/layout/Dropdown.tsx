	...
	return (
		<div style={{ float: 'right' }} id="dropdown">
			...
			<div className="dropdown-content">
				...
				{loggedIn ?
					<DropdownItem label="Profile" link="/profile" isCurrent={currentPage === 'profile'} /> :
					<DropdownItem label="Login" link="/login" isCurrent={currentPage === 'login'} disabled={userless} />
				}
			</div>
		</div>
	);
