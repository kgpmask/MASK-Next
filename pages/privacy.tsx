		...
		<>
			...
			<TextPage title='Privacy Policy'>
				<p>
					...
					information that is collected and recorded by MASK and how we use it.
				</p>

				<p>
					If you have additional questions or require more information about our Privacy Policy, please contact us at{' '}
					<Link href='mailto:kgpmask@gmail.com' target='_blank'>
						kgpmask@gmail.com
					</Link>
				</p>
				...
				<p>
					...
					the information that they shared and/or collect in MASK. This policy is not applicable to any information collected
					offline or via channels other than this website. Our Privacy Policy was created with the help of the{' '}
					<Link href='https://www.privacypolicygenerator.info'>Free Privacy Policy Generator</Link>.
				</p>
				<br />
				...
				<h2>Log Files</h2>
				<p>
					MASK follows a standard procedure of using log files. These files log visitors when they visit websites. All
				...
				<p>
					Like any other website, MASK uses &apos;cookies&apos;. These cookies are used to store information including
				...
				<p>
					...
					their respective advertisements and links that appear on MASK, which are sent directly to users&apos; browser. They
				...
				<p>Note that MASK has no access to or control over these cookies that are used by third-party advertisers.</p>
				<br />

				<h2>Third Party Privacy Policies</h2>
				<p>
					MASK&apos;s Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to consult
				...
				<p>
					MASK does not knowingly collect any Personal Identifiable Information from children under the age of 13. If you
