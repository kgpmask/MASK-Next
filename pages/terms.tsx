		...
		<>
			...
			<TextPage title='Terms and Conditions'>
				...
				<p>
					...
					<Link href='https://kgpmask.club/' target='_blank' rel='noopener noreferrer'>
						https://kgpmask.club/
					</Link>
				...
				<p>
					By accessing this website we assume you accept these terms and conditions. Do not continue to use MASK if you do
				...
				<p>
					...
					manner for the express purpose of meeting the Client&apos;s needs in respect of provision of the Company&apos;s
				...
				<h2> Cookies </h2>
				<p>
					We employ the use of cookies. By accessing MASK, you agreed to use cookies in agreement with the{' '}
					<Link href='https://kgpmask.club/' target='_blank' rel='noopener noreferrer'>
						https://kgpmask.club/
					</Link>
					&apos;s Privacy Policy.{' '}
				...
				<p>
					...
					by our website to enable the functionality of certain areas to make it easier for people visiting our website. Some
				...
				<p>
					...
					and/or its licensors own the intellectual property rights for all material on MASK. All intellectual property
					rights are reserved. You may access this from MASK for your own personal use subjected to restrictions set in these
				...
				<p>
					...
					<Link href='https://www.privacypolicies.com/blog/sample-terms-conditions-template/'>
				...
				<p>
					...
					must inform us by sending an e-mail to{' '}
					<Link href='mailto:kgpmask@gmail.com' target='_blank' rel='noopener noreferrer'>
						kgpmask@gmail.com
					</Link>
					. Please include your name, your organization name, contact information as well as the URL of your site, a list of
					any URLs from which you intend to link to our Website, and a list of the URLs on our site to which you would like
